  ...
  html: (link: string, company: string) => `
    <div style="background:#fff;padding:0;margin:0;font-family:Arial,sans-serif;">
      ...
      <div style="max-width:480px;margin:0 auto;background:#fff;border-radius:10px;padding:24px 18px 32px 18px;box-shadow:0 2px 8px #e0e7ef;">
        <h2 style="text-align:center;font-size:20px;font-weight:700;margin:0 0 18px 0;color:#222;">Aicinājums pievienoties uzņēmumam</h2>
        <p style="font-size:15px;color:#222;text-align:center;margin:0 0 18px 0;">Jūs esat uzaicināts pievienoties uzņēmumam <b>${company}</b> Domera.lv platformā.</p>
