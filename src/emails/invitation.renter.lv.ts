export default {
  subject: 'Ielūgums kļūt par īrnieku',
  html: (link: string, apartment: string) => `
    <div style="background:#fff;padding:0;margin:0;font-family:Arial,sans-serif;">
      ...
      <div style="max-width:480px;margin:0 auto;background:#fff;border-radius:10px;padding:24px 18px 32px 18px;box-shadow:0 2px 8px #e0e7ef;">
        <h2 style="text-align:center;font-size:20px;font-weight:700;margin:0 0 18px 0;color:#222;">Aicinājums kļūt par dzīvokļa īrnieku</h2>
        <p style="font-size:15px;color:#222;text-align:center;margin:0 0 18px 0;">Jūs esat uzaicināts kļūt par dzīvokļa <b>${apartment}</b> īrnieku Domera.lv platformā. Jūs varēsiet iesniegt skaitītāju rādījumus tiešsaistē.</p>
        <div style="text-align:center;margin:24px 0;">
          <a href="${link}" style="display:inline-block;padding:12px 32px;background:#2563eb;color:#fff;font-size:16px;font-weight:600;border-radius:8px;text-decoration:none;">Pieņemt ielūgumu</a>
        </div>
