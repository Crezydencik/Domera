...
const AuthLayout: React.FC<AuthLayoutProps> = ({ children }) => {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="relative w-full sm:w-1/2 max-w-full bg-white shadow-xl z-10 min-h-screen flex flex-col auth-mobile-form">
        {/* Хедер закреплён сверху */}
        <div className="w-full flex items-center justify-between bg-white z-20 px-8 pt-4 pb-2 auth-mobile-header" style={{minHeight: 40}}>
        ...
        <div className="flex-1 flex flex-col justify-center items-center auth-mobile-center">
      ...
      <div className="relative hidden sm:flex w-1/2 min-h-screen items-center justify-center overflow-hidden bg-linear-to-br from-indigo-700 via-blue-700 to-violet-700 auth-mobile-hide-sm">
